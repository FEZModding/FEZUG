...
@FOR /F "tokens=2* skip=2" %%a in ('reg query "HKCU\SOFTWARE\Valve\Steam" /v "SteamPath"') do set fezpath="%%b/steamapps/common/FEZ/Mods/FEZUG"
...
@if ERRORLEVEL 0 (
	@REM 
	copy "D:\Github\FEZUG\bin\Debug\*"
	copy "D:\Github\FEZUG\Metadata.xml"
